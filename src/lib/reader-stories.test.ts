...
function makeValidReaderStory() {
  return {
    ...
    statements: [
      ...
      { id: "claim-unknown", type: "unresolved", basis: "evidence_gap", text: "The note alone cannot establish how the trial will affect every routine.", sourceIds: ["ward-note"], sourceScope: "The supplied note describes a plan but contains no measured outcome.", evidenceNeed: "Independent access checks and reporting from people who use the street." }
    ],
