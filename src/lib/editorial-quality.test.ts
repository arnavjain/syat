...
function makeStory(paragraphs?: [string, string, string]): GeneratedStoryV2 {
  ...
  return parseGeneratedStoryV2({
    ...
    story: { mode: "news", title: "Bazaar Road bus-priority trial gets a planned start date", dek: "The city record names the road and date, while travel effects and on-ground implementation remain unverified.", theme: "Cities and public life", indiaConnection: "The transport record concerns Bazaar Road in an Indian municipal setting and people who use it.", eventTime: { kind: "exact_date", value: "2026-09-01", label: "From 1 September 2026" }, eventTimeEvidence: { claimIds: ["planned-trial"], sourceIds: ["city-record"] }, reframe: { kind: "question", value: "What evidence would show how the bus-priority change works on the ground?" } },
    bodySections: [
    ...
    timeline: [{ id: "start", time: { kind: "exact_date", value: "2026-09-01", label: "1 September 2026" }, text: "The record gives this as the planned start date for the trial.", claimIds: ["planned-trial"], sourceIds: ["city-record"] }],
    statements: [
      { id: "planned-trial", type: "documented", basis: "official_claim", text: "According to the city record, the authority intends to begin the Bazaar Road trial on 1 September.", sourceIds: ["city-record"], sourceScope: "The statement reports the plan described by the city transport record.", limits: "It does not confirm on-ground implementation or any measured effect." },
