...
const themes = [
  ...
  ["Polity and power in India", "system", [
    ["judicial-appointments", "Who should choose the judges who check the government?"],
    ["governor-role", "What is an unelected governor for?"],
    ["speech-and-the-state", "Which speech may a state punish?"],
    ["anti-defection", "Does the anti-defection law strengthen parties or silence members?"],
    ["reservation-horizon", "What would tell us reservation had done its work?"],
    ["personal-law-question", "What would a uniform civil code have to get right?"],
    ["electoral-funding", "Who is entitled to know who funds a party?"],
    ["centre-state-money", "Should a state that raises more revenue keep more of it?"],
  ]],
  ["India and the world", "idea", [
    ["non-alignment-now", "What survives of non-alignment when everyone wants an alignment?"],
    ["strategic-autonomy", "Can a country stay unaligned and still be defended?"],
    ["neighbourhood-first", "Why is being the largest neighbour a disadvantage?"],
    ["migration-and-remittance", "What does a country lose when its workers leave?"],
    ["diaspora-claim", "What claim does a diaspora have on the country it left?"],
    ["multilateral-reform", "Who benefits from institutions nobody will reform?"],
    ["border-lives", "What does a border do to the people who live on it?"],
    ["aid-and-influence", "When is development assistance a gift?"],
  ]],
  ["Environment and its trade-offs", "place", [
    ["conservation-and-livelihood", "Who pays for a protected forest?"],
    ["nuclear-question", "Is nuclear power a climate answer or a transferred risk?"],
    ["growth-and-emissions", "Can a poor country afford to slow down?"],
    ["historical-emissions", "Who owes what for emissions already released?"],
    ["river-linking", "What does moving a river assume about the one it leaves?"],
    ["stubble-burning", "Why does a known, solvable problem return every year?"],
    ["carbon-offset", "What does a carbon offset actually buy?"],
    ["wildlife-and-neighbour", "What is owed to people who live beside dangerous animals?"],
  ]],
  ["Economics, argued", "system", [
    ["growth-or-distribution", "Does growth have to come before distribution?"],
    ["formalising-work", "What is lost when informal work is formalised?"],
    ["subsidy-question", "When does a subsidy stop reaching the person it names?"],
    ["minimum-wage-effect", "What does a minimum wage do that its critics deny?"],
    ["land-acquisition", "What is land worth to someone who will not sell it?"],
    ["cash-or-kind", "Should the state give money or give the thing?"],
    ["trade-and-jobs", "Who carries the cost of a gain from trade?"],
    ["inflation-target", "Whose inflation does a central bank target?"],
  ]],
  ["Science, where it is genuinely open", "system", [
    ["replication-failure", "What does a failed replication actually falsify?"],
    ["dual-use-research", "Should a dangerous finding be published?"],
    ["gene-editing-line", "Where should gene editing stop, and who decides?"],
    ["machine-understanding", "What would settle whether a machine understands anything?"],
    ["research-animal", "What does a research animal's suffering weigh against?"],
    ["trial-equipoise", "When does continuing a trial become the wrong thing to do?"],
    ["deference-to-consensus", "When should a public defer to expert consensus?"],
    ["intelligence-measure", "What does an intelligence test actually measure?"],
  ]],
  ["Philosophy, unresolved", "idea", [
    ["free-will-and-blame", "If choices have causes, what is blame for?"],
    ["explaining-experience", "Can physical description ever explain what experience is like?"],
    ["moral-discovery", "Are moral claims discovered, or agreed?"],
    ["same-person", "What makes you the same person you were?"],
    ["moral-status", "What earns something a claim on our consideration?"],
    ["owing-the-unborn", "What do we owe people who do not exist yet?"],
    ["honest-lie", "Can a lie ever be the honest act?"],
    ["luck-and-desert", "How much of what you have did you actually earn?"],
  ]],
